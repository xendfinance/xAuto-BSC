...
contract xBUSD is ERC20, ERC20Detailed, ReentrancyGuard, Ownable, TokenStructs {
  ...
  constructor () public ERC20Detailed("xend BUSD", "xBUSD", 18) {
  ...
  function supplyNerve(uint amount) public {
      ...
      INerveAdapter(nerveAdapter).deposit(amount, 0);
  }
  ...
  function _withdrawNerve(uint amount) internal {
      ...
      INerveAdapter(nerveAdapter).withdrawBySharesOnly(amount, 0);
  }
